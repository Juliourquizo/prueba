...
namespace FACTURA.Migrations
{
    ...
    [Migration("20221213125343_InitialCreate")]
            ...
            modelBuilder.Entity("FACTURA.Models.Linea", b =>
                {
                    ...
                    b.Property<int>("HojaFacturaIdHojaFactura")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HojaFacturaIdHojaFactura");
            ...
            modelBuilder.Entity("FACTURA.Models.Linea", b =>
                {
                    b.HasOne("FACTURA.Models.HojaFactura", "HojaFactura")
                        .WithMany("Lineas")
                        .HasForeignKey("HojaFacturaIdHojaFactura")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
